"""
Django settings for license_keys_project project.
...
environ.Env.read_env(os.path.join(BASE_DIR, 'license_keys_project/.env'))
...
WSGI_APPLICATION = 'license_keys_project.wsgi.application'
